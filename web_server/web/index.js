fetch('https://140.118.121.104:6789/account/open_list',{
  method: 'GET',
  headers: {
...
Livenow.addEventListener('submit', function (e) {
    ...
    let param = "https://140.118.121.104:6789/account/open_room?S_Account="+account;
    console.log(param);
...
function openroom(data){
  ...
  let param = "https://140.118.121.104:6789/account/edit?S_Account="+S_Account
  fetch(param,{
      method: 'GET',
      headers: {
        'Accept': 'application/json, text/plain',
